		...
		extend: {
			colors: {
				...
				'surface-container-low':
					'var(--color-surface-container-low, #F5F5F5)',
				'surface-container-high':
					'var(--color-surface-container-high, #ECE6F0)',
				'surface-container-highest':
					'var(--color-surface-container-highest, #E6E0E9)',
				'on-surface': 'var(--color-on-surface, #1C1B1F)',
				'on-surface-variant':
					'var(--color-on-surface-variant, #49454F)',
